...
class DynEulEnDis:
    ...
    def step(dyn: DynData, dt: float, ng: int = 1) -> None:
        ...
        y1, y2, y3 = en[:,jb:je,2:-4], en[:,jb:je,3:-3], en[:,jb:je,4:-2]
        enxx = (y1 -2*y2 + y3)*dg.a_rdx[jb:je,ib:ie]**2
        y1, y2, y3 = deepcopy(en[:,jb:je,ib:ie]), deepcopy(en[:,jb:je,ib:ie]), deepcopy(en[:,jb:je,ib:ie])
        y1[1:,jb:je,ib:ie] = y2[:-1,jb:je,ib:ie]
        y1[0,jb:je,ib:ie] = y2[0,jb:je,ib:ie]
        y3[:-1,jb:je,ib:ie] = y2[1:,jb:je,ib:ie]
        y3[-1,jb:je,ib:ie] = y2[-1,jb:je,ib:ie]
        enzz = (y1 -2*y2 + y3)/dz[:,jb:je,ib:ie]**2
        rhs_en += dp[:,jb:je,ib:ie] * K * (enxx + enzz) * dt

        en[:,jb:je,ib:ie] = (en0[:,jb:je,ib:ie]*dp0[:,jb:je,ib:ie] + rhs_en) / dp[:,jb:je,ib:ie]
        ...
        if mp.npx > 2:
            ...
            y1, y2, y3 = ua[:,jb:je,2:-4], ua[:,jb:je,3:-3], ua[:,jb:je,4:-2]
            uxx = (y1 -2*y2 + y3)*dg.a_rdx[jb:je,ib:ie]**2
            y1, y2, y3 = deepcopy(ua[:,jb:je,ib:ie]), deepcopy(ua[:,jb:je,ib:ie]), deepcopy(ua[:,jb:je,ib:ie])
            y1[1:,jb:je,ib:ie] = y2[:-1,jb:je,ib:ie]
            y1[0,jb:je,ib:ie] = y2[0,jb:je,ib:ie]
            y3[:-1,jb:je,ib:ie] = y2[1:,jb:je,ib:ie]
            y3[-1,jb:je,ib:ie] = y2[-1,jb:je,ib:ie]
            uzz = (y1 -2*y2 + y3)/dz[:,jb:je,ib:ie]**2
            rhs_ua += dp[:,jb:je,ib:ie] * K * (uxx + uzz) * dt
        ...
        y1, y2, y3 = -wa[:,jb:je,2:-4], -wa[:,jb:je,3:-3], -wa[:,jb:je,4:-2]
        wxx = (y1 -2*y2 + y3)*dg.a_rdx[jb:je,ib:ie]**2
        y1, y2, y3 = deepcopy(-wa[:,jb:je,ib:ie]), deepcopy(-wa[:,jb:je,ib:ie]), deepcopy(-wa[:,jb:je,ib:ie])
        y1[1:,jb:je,ib:ie] = y2[:-1,jb:je,ib:ie]
        y1[0,jb:je,ib:ie] = -y2[0,jb:je,ib:ie]
        y3[:-1,jb:je,ib:ie] = y2[1:,jb:je,ib:ie]
        y3[-1,jb:je,ib:ie] = -y2[-1,jb:je,ib:ie]
        wzz = (y1 -2*y2 + y3)/dz[:,jb:je,ib:ie]**2
        rhs_wa += -dp[:,jb:je,ib:ie] * K * (wxx + wzz) * dt
        
        wa[:,jb:je,ib:ie] = (wa0[:,jb:je,ib:ie]*dp0[:,jb:je,ib:ie] + rhs_wa) / dp[:,jb:je,ib:ie]
