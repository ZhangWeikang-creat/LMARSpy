...
class DynEulDis:
    ...
    def step(dyn: DynData, dt: float, ng: int = 1) -> None:
        ...
        y1, y2, y3 = pt[:,jb:je,2:-4], pt[:,jb:je,3:-3], pt[:,jb:je,4:-2]
        ptxx = (y1 -2*y2 + y3)*dg.a_rdx[jb:je,ib:ie]**2
        y1, y2, y3 = deepcopy(pt[:,jb:je,ib:ie]), deepcopy(pt[:,jb:je,ib:ie]), deepcopy(pt[:,jb:je,ib:ie])
        y1[1:,jb:je,ib:ie] = y2[:-1,jb:je,ib:ie]
        y1[0,jb:je,ib:ie] = y2[0,jb:je,ib:ie]
        y3[:-1,jb:je,ib:ie] = y2[1:,jb:je,ib:ie]
        y3[-1,jb:je,ib:ie] = y2[-1,jb:je,ib:ie]
        ptzz = (y1 -2*y2 + y3)/dz[:,jb:je,ib:ie]**2
        rhs_pt += dp[:,jb:je,ib:ie] * K * (ptxx + ptzz) * dt

        pt[:,jb:je,ib:ie] = (pt0[:,jb:je,ib:ie]*dp0[:,jb:je,ib:ie] + rhs_pt) / dp[:,jb:je,ib:ie]
